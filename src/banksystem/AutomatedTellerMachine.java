...
public class AutomatedTellerMachine {
    ...
    private static int nextID = 1;//000001
    ...
    /**
     * Constructor with 1 parameter(atmID)
     * @param atmID: an given atmID for an ATM
     */
    ...
    /**
     * Copy constructor: copy all info of an ATM to another ATM
     * @param automatedTellerMachine: an ATM to be copied 
     */
